...
Dim bInQuote As Boolean
  ...
  StartMsg "Importing data..."
    ...
    szTable = lvTables.SelectedItem.Text
...
Dim objNamespace As pgNamespace
  ...
  StartMsg "Examining Server..."
  For Each objNamespace In svr.Databases(lvDatabases.SelectedItem.Text).Namespaces
    If (Not objNamespace.SystemObject) Or (objNamespace.Name = "public") Then
      For Each objTable In objNamespace.Tables
        If Not objTable.SystemObject Then
          Set objItem = lvTables.ListItems.Add(, , objTable.FormattedID, "table", "table")
...
Dim objColumn As pgColumn
  ...
  StartMsg "Examining Server..."
  For Each objColumn In svr.Databases(lvDatabases.SelectedItem.Text).Namespaces(lvTables.SelectedItem.Tag.Namespace).Tables(lvTables.SelectedItem.Tag.Name).Columns
    If Not objColumn.SystemObject Then
      Set objItem = lvColumns.ListItems.Add(, , objColumn.FormattedID, "column", "column")
