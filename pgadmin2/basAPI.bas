...
'relaction structure
Public Type RelationStrucutre
  Name As String
  Tag As String
End Type

Public Type RelationStructureJoin
  Relation1 As RelationStrucutre
  NameDataRelation1 As String
  Relation2 As RelationStrucutre
  NameDataRelation2 As String
End Type
